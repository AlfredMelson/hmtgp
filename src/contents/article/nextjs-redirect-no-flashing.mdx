...
This code is using useEffect in the Authentication Context, to verify the token that is usually stored in localStorage. You can check my library to [learn more about Authentication Context pattern](http://hmtgp.com/library/auth-context)
