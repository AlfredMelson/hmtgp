...
Lobotomized Owl biasanya menggunakan relative units sehingga besarnya relatif pada font size containernya. Untuk mengetahui relative units lebih lanjut, baca [blog saya tentang rem, em, dan px unit](https://hmtgp.com/blog/btb-rem-em)
...
Notice penggunaan space between untuk mereduce class yang digunakan. Code ini saya ambil dari website ini, codenya dapat [diakses di github](https://github.com/theodorusclarence/hmtgp.com). Kindly star kalo membantu!
  ...
  return (
    <button
      className={clsx(
        ...
        'focus-visible:ring-primary-300 focus:outline-none focus-visible:ring disabled:cursor-not-allowed'
      )}
      {...rest}>
      {children}
    </button>
