...
Potongan code ini menggunakan useEffect di authentication context, untuk memverifikasi token yang biasanya disimpan di localStorage. Jika kamu ingin mengetahu Authentication Context pattern lebih lanjut, saya memiliki [code snippet](http://hmtgp.com/library/auth-context) tentang itu.
...
> I'm open for all suggestions and contributions to improve 🚀. Open a PR on the repository or email me at me@hmtgp.com
