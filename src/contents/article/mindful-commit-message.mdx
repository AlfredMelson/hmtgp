...
Commit message will be checked using [husky and commit lint](https://hmtgp.com/library/husky-commitlint-prettier), you can't commit if not using the proper convention below.
...
Check out this [post](https://hmtgp.com/library/husky-commitlint-prettier#2-add-commitlint) to add Commitlint using Husky
